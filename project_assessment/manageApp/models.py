...
class Common(models.Model):
    ...
    def __str__(self) -> str:
        return self.Full_Name if self.Full_Name else self.Master.Email
...
class Student(models.Model):
    ...
    def __str__(self) -> str:
        return self.Roll_Number if self.Common.Full_Name else self.Common.Master.Email
...
class Teacher(models.Model):
    ...
    def __str__(self) -> str:
        return  self.Common.Full_Name if self.Common.Full_Name else self.Common.Master.Email
